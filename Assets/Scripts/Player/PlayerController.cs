...
public class PlayerController : Character, IHealth
{
    ...
    {
        SpawnPointController spawnPoint = FindAnyObjectByType<SpawnPointController>();
        Debug.Log("spwanPoint name=" + spawnPoint.spawnPointName);
